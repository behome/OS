...
unsigned int mememan_alloc(struct MEMMAN *man, unsigned int size);
...
struct TSS32{
	...
	int eip, eflags, eax, ecx, edx, ebx, esp, esi, edi, ebp;
...
struct TASKCTL{
	...
	char lv_change;/*下次任务切换时是否要改变LEVEL*/
...
void putfonts8_asc_back(struct SHEET *sht, int x, int y, int b, int l);
